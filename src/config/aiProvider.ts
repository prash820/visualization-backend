...
// Fallback provider: Anthropic Claude (for rate limit fallback)
...
if (typeof window === 'undefined') {
  ...
  console.log('[AI CONFIG] Primary model:', OPENAI_MODEL);
  console.log('[AI CONFIG] Fallback model:', ANTHROPIC_MODEL);
}
