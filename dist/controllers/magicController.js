...
const promptEngine_1 = __importDefault(require("../config/promptEngine"));
...
function analyzeAppIdea(jobId, prompt, targetCustomers, projectId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const promptEngine = promptEngine_1.default.getInstance();
            const analysisPrompt = promptEngine.getAnalysisPrompt(prompt, targetCustomers);
            const analysisResponse = yield makeAIRequest(analysisPrompt, promptEngine.getSystemPrompt());
...
function generateUMLDiagrams(jobId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const umlResponse = yield makeAIRequest(umlPrompt, promptEngine.getSystemPrompt());
...
function generateApplicationCode(jobId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const appCode = yield generateApplicationCodeWithRetry(codePrompt, userPrompt || 'App generation', 3);
